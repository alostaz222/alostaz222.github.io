const head = document.head;
        ...
        class SpecialHeader extends HTMLElement {
            connectedCallback() {
                ...
                const navBtn = this.querySelectorAll('.material-icons');
                ...
                // Toggle sidebar and margin on sideOpen click
                document.getElementById('sideOpen').addEventListener('click', function() {
                    if (sidebar.style.display === 'flex') {
                        sidebar.style.display = 'none';
                        document.getElementById('third-container').style.marginRight = '12px';
                    } else {
                        sidebar.style.display = 'flex';
                        document.getElementById('third-container').style.marginRight = '';
                    }
                });

                // Toggle sidebar and margin on sideClose click
